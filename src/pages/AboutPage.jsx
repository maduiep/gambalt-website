...
export const AboutPage = ({ setPage }) => {
  ...
  const team = [
    ...
    { name: "Engr. David Nwachukwu", role: "Head of Safety & Compliance", img: "https://images.unsplash.com/photo-1603696774905-83ae340e2cae?w=400&h=400&fit=crop&crop=faces&q=80", desc: "Ensures all project documentation meets government regulations and ISO standards company-wide." },
  ];
